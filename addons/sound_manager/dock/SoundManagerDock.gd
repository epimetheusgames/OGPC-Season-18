...
func _connect_signals() -> void:
	...
	# Bus fields
	bgm_bus_field.text_submitted.connect(_on_bgm_bus_entered)
	bgs_bus_field.text_submitted.connect(_on_bgs_bus_entered)
	se_bus_field.text_submitted.connect(_on_se_bus_entered)
	me_bus_field.text_submitted.connect(_on_me_bus_entered)
...
func _update_gui() -> void:
	...
	bgm_bus_field.text = Audio_Busses["BGM"]
	bgs_bus_field.text = Audio_Busses["BGS"]
	se_bus_field.text = Audio_Busses["SFX"]
	me_bus_field.text = Audio_Busses["MFX"]
